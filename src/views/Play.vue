  ...
  <div class="queue-page">
    ...
    >
      <bike-tag-button
        ...
        text="1"
      />
      <img v-if="BiketagFormSteps[getFormStep] == 1.5" class="step__arrow" :src="arrowSvg" alt="next" />
      <span v-else class="step__line" :style="`background-image: url(${lineSvg})`" />
      <bike-tag-button
        :variant="BiketagFormSteps[getFormStep] == 2 ? 'circle-clean' : 'empty'"
        text="2"
      />
      <img v-if="BiketagFormSteps[getFormStep] == 2.5" class="step__arrow" :src="arrowSvg" alt="next"/>
