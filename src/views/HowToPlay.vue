  ...
  <div class="container mt-5">
    ...
    >
      ...
      <swiper-slide>
        ...
        <div><img class="img-fluid w-75" src="@/assets/images/bike1.png" alt="how to biketag #1" /></div>
      </swiper-slide>
      <swiper-slide>
        <p>{{ $t('pages.howto.swiper3.text1') }}</p>
        <div class="mb-2"><img class="img-fluid w-50" src="@/assets/images/bike1.png" alt="how to biketag #1" /></div>
        <div><img class="img-fluid w-50 mb-5" src="@/assets/images/bike2.png" alt="how to biketag #2" /></div>
      </swiper-slide>
      <swiper-slide>
        <p>{{ $t('pages.howto.swiper4.text1') }}</p>
        <div class="mb-3"><img class="img-fluid w-75" src="@/assets/images/bike3.png" alt="how to biketag #3" /></div>
        <p>{{ $t('pages.howto.swiper4.text2') }}</p>
      </swiper-slide>
      <swiper-slide>
        <p>{{ $t('pages.howto.swiper5.text1') }}</p>
        <div class="mb-3">
          <img class="img-fluid w-75" src="@/assets/images/good-examples.png" alt="how to biketag - good examples" />
        </div>
      ...
      <swiper-slide>
        ...
        <div class="mb-3">
          <img class="img-fluid w-75" src="@/assets/images/not-so-good-examples.png"  alt="how to biketag - not so good examples" />
        </div>
      ...
      <swiper-slide>
        ...
        <div class="mb-3">
          <img class="img-fluid w-50" src="@/assets/images/queue-tag.png" alt="how to queue a biketag" />
        </div>
      ...
      <swiper-slide>
        ...
        <div class="mb-3">
          <img class="img-fluid w-50" src="@/assets/images/submit-tag.png" alt="how to submite a biketag" />
        </div>
